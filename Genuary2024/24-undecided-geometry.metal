// #genuary24 Undecided geometry. Turn Z-testing off
// In MantisShrimp, untick the flag is3D. Also, set 
// Object Grid to 2x4 and Scale to 2.
...
void objectStage()
{
    ...
    float2 offset = oj % 2 == 0 ? float2(0.5,1.5) : float2(1.5,1.5);
    ...
    // for animation
    float step = 10 * uni.time / float(n);
